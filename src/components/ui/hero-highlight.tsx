...
return (
    <div
    className={cn(
        "group relative flex h-[40rem] w-full items-center justify-center bg-neutral-900",
        containerClassName,
    )}
...
return (
    ...
    className={cn(
        `relative inline-block rounded-full bg-gradient-to-r from-indigo-300 to-purple-300 dark:from-neutral-900 dark:to-neutral-900 text-3xl py-2 px-6`,
        className,
    )}
    >
    {children}
